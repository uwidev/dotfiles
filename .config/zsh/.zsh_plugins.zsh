...
fpath+=( "$HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-ocodo-SLASH-ollama_zsh_completion" )
fpath+=( "$HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-lervag-SLASH-apy" )
fpath+=( "$HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-z-shell-SLASH-zsh-eza" )
source "$HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-z-shell-SLASH-zsh-eza/zsh-eza.plugin.zsh"
